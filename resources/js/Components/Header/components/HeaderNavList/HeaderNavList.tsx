...
function HeaderNavList(/* { listCartProduct, isAuthenticated }: Props */) {
    ...
    // useEffect(() => {
    //     setLocationCart(
    //         document.querySelector<HTMLElement>("#cart-btn") as HTMLElement
    //     );
    ...
    return (
        <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-2">
            <form
                /* onSubmit={handleSearch} */ className="flex w-96 items-center"
            >
                ...
                <div className="relative w-full">
                    ...
                    <input
                        type="text"
                        className="outline-none block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-orange-500 focus:ring-blue-500"
                        placeholder="Nhập tên sự kiện, vé, ..."
                        required
                        value={searchParam}
                ...
                <IconButton
                    type="submit"
                    className="ml-2 rounded-lg border bg-orange-500  p-2.5 text-sm font-medium text-white hover:bg-orange-700 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                    <FontAwesomeIcon
            ...
            {/* <Menu open={openMenu} handler={setOpenMenu}>
                ...
                <MenuList
                    ...
                    className={`hidden w-[28rem] grid-cols-4 gap-3 overflow-visible ${
                        currentURL === `http://localhost:3000${routes.cart}`
                            ? ""
                            : "lg:grid"
                    }`}
                >
                    {listCartProduct?.length === 0 || !isAuthenticated ? (
                        <div className="col-span-4 mb-16 text-center">
                            ...
                            />
                            <p className="mb-4 text-base font-medium md:mb-3">
                        ...
                        <div className="col-span-4">
                            ...
                            <Link
                                to={routes.cart}
                                className="col-span-4 mt-3 flex justify-end"
                            >
